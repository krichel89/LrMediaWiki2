...
return {
	id = 'LrMediaWiki2MetadataSetObjectPhoto', -- needs to be unique!
	title = 'LrMediaWiki2 – Object Photo', -- no localization needed
	items = {
		{ 'com.adobe.label', label = 'LrMediaWiki2 – Object Photo' }, -- no localization needed
